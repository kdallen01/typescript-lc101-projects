...
//    return daysToLocation = hoursToLocation/24;
//}
// Move your output statement from part 2 here. Update the template literal to call
// the function and print the outputs for a Mars trip and a moon trip.
//console.log(`It will take ${spacecraftName} ${getDaysToLocation(kilometersToMars)} days to get to the Mars!`);
...
var spacecraft = /** @class */ (function () {
    function spacecraft(spaceCraftName, speedMph) {
        ...
        this.name = spaceCraftName, this.speedMph = speedMph;
    }
